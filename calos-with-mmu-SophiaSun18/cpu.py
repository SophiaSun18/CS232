...
class CPU:
    ...
    def set_mmu_registers(self, relocval, limitval):
        """Call this method to set the mmu registers."""
        self._mmu.set_reloc_register(relocval)
        self._mmu.set_limit_register(limitval)
